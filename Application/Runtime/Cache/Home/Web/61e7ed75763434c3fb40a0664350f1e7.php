	            	...
	            	<td colspan="5">
	            		<div class="pay-table">
				        	<div class="pay-title">
				        		...
				        		<b <?php if(($black) < $price): ?>class="active"<?php endif; ?>>平台支付</b>
				        		<b>借记卡</b>
				        		<b>信用卡</b>
				        	</div>
				        	<div class="pay-nav">
				        	...
				        	<div class="pay-nav">
				        		<h5>平台支付</h5>
				        		<?php if(!empty($wx_pay)): ?><label class="pay-label <?php if(($black) < $price): ?>active<?php endif; ?>" title="微信支付">
				        		...
				        		<?php if(!empty($pay_pal)): ?><label class="pay-label" title="PAYPAL">
					        			<span class="paypal" data-paytype="6"></span>
					        		</label><?php endif; ?>
				        	</div>
