...
<script type="text/javascript" src="/onepay/Public/Admin/js/bootstrap/dist/js/bootstrap.min.js"></script>
	...
	<script type="text/javascript" src="/onepay/Public/Static/uploadify/jquery.uploadify.min.js"></script>
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#upload_picture").uploadify({
				"height"          : 35,
				"swf"             : "/onepay/Public/Static/uploadify/uploadify.swf",
			...
			function uploadPicture(file, data){
				...
				if(data.status){
					...
					src = data.url || '/onepay' + data.path
					$("#shop-pic").html(
						'<img src="/onepay' + src + '" class="img-thumbnail" style="height:100px;"/>'
					);
				} else {
