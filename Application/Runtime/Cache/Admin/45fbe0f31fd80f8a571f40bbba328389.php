				...
				<div class="content">
					<div class="col-sm-12">
						<div class="pull-right">
							<a class="btn btn-success" href="<?php echo U('add');?>" ><i class="fa fa-plus-square"></i> 添加幻灯</a>
						</div>
					</div>
					<table class="no-border blue">
						...
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td style="width:30%;"><?php echo ($vo["link"]); ?></td>
							<td style="width:20%;"><img src="<?php echo (get_cover($vo['cover_id'],"path")); ?>" class="img-thumbnail" style="height:100px;"/></td>
							<td style="width:20%;"><?php echo (time_format($vo["update_time"],"Y-m-d")); ?></td>
							<td class="text-right">
...
<script type="text/javascript" src="/onepay/Public/Admin/js/bootstrap/dist/js/bootstrap.min.js"></script>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			highlight_subnav('<?php echo U('Slider/index');?>');
		});
	</script>
