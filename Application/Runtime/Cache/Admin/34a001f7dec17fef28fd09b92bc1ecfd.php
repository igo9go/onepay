...
<head>
	...
	<!--[if lt IE 9]>
		...
		<![endif]-->
	<!-- Bootstrap core CSS -->
	<link rel="stylesheet" type="text/css" href="/onepay/Public/Admin/js/jquery.nanoscroller/nanoscroller.css" />
	<link rel="stylesheet" type="text/css" href="/onepay/Public/Admin/js/jquery.select2/select2.css" />
	<link rel="stylesheet" type="text/css" href="/onepay/Public/Admin/js/bootstrap.slider/css/slider.css" />
	<link rel="stylesheet" type="text/css" href="/onepay/Public/Admin/css/pygments.css" />
				...
				<div class="content">
					<div class="col-sm-12">
						<div class="pull-right">
							<button type="button" class="btn btn-success btn-rad md-trigger" url="<?php echo U('Ten/add');?>" data-modal="form-primary"><i class="fa fa-plus-square"></i> 添加专区</button>
						</div>
					</div>
					<div class="category">
						<div class="row color-primary">
							<div class="col-sm-2 col-md-4 col-lg-1">ID</div>
							<div class="col-sm-6 col-md-6 col-lg-8">专区名称</div>
							<div class="col-sm-4 col-md-4 col-lg-2 text-right">操作</div>
						</div>
						<?php if(is_array($tree)): $i = 0; $__LIST__ = $tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><div class="row">
								<div class="col-sm-2 col-md-4 col-lg-1"><?php echo ($list['id']); ?></div>
					            <div class="col-sm-6 col-md-6 col-lg-8"><?php echo ($list["title"]); ?></div>
					            <div class="col-sm-4 col-md-4 col-lg-2 text-right">
					                <a data-placement="left" data-toggle="tooltip" data-original-title="修改专区" class="label label-primary md-trigger" url="<?php echo U('Ten/edit?id='.$list['id']);?>" href="#"><i class="fa fa-pencil"></i></a>
					                <a data-placement="left" data-toggle="tooltip" data-original-title="删除专区" class="label label-danger ajax-get" href="<?php echo U('Ten/remove?id='.$list['id']);?>"><i class="fa fa-times"></i></a>
					            </div>
...
<script type="text/javascript" src="/onepay/Public/Admin/js/jquery.ui/jquery-ui.js"></script>
<script type="text/javascript" src="/onepay/Public/Admin/js/jquery.nanoscroller/jquery.nanoscroller.js"></script>
<script type="text/javascript" src="/onepay/Public/Admin/js/bootstrap.switch/bootstrap-switch.min.js"></script>
<script type="text/javascript" src="/onepay/Public/Admin/js/bootstrap.datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="/onepay/Public/Admin/js/jquery.select2/select2.min.js"></script>
<script type="text/javascript" src="/onepay/Public/Static/layer/layer.js"></script>
...
<script type="text/javascript">
	$(document).ready(function(){		
		...
		highlight_subnav('<?php echo U('Ten/index');?>');
	});
</script>
